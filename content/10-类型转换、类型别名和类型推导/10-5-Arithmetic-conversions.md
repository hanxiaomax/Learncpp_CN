...
>   - 否则 (两个操作数的类型均不在表中)，则两个操作数会进行[[numeric promotions|数值提升]](参见：[[10-2-Floating-point-and-integral-promotion|10.2 - 浮点数和整型提升]])。
...
在[[6-1-Operator-precedence-and-associativity|6.1 - 运算符优先级和结合律]]中我们讨论过，表达式是如何基于优先级和结合律进行运算的。
