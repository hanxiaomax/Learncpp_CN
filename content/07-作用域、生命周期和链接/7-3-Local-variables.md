...
> [!info] "相关内容"
> 如果你忘记了什么是代码块，请参考[[7-2-User-defined-namespaces-and-the-scope-resolution-operator|7.2 - 用户定义命名空间和作用域解析运算符]]。
...
> [!info] "相关内容"
> 我们会在[[7-5-Variable-shadowing-name-hiding|7.5 - 变量遮蔽]]中讨论具一个变量与其嵌套语句块中的同名变量之间有什么影响。
